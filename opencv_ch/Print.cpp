...
void Print_Mat(Mat* tmp) {
	...
	for (int i = 120; i < 780; i++) {
		for (int j = 0; j < 10; j++) {
			mat.at<Vec3b>(Point(i, 120 + j)) = Vec3b(125, 50, 100);
			mat.at<Vec3b>(Point(120 + j, i)) = Vec3b(125, 50, 100);
			mat.at<Vec3b>(Point(i, 770 + j)) = Vec3b(125, 50, 100);
			mat.at<Vec3b>(Point(770 + j, i)) = Vec3b(125, 50, 100);
